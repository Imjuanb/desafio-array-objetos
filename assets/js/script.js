...
const minimumMeters = document.querySelector("#minimumMeters");
const maximumMeters = document.querySelector("#maximumMeters");
...
btnFilter.addEventListener("click", () => {
  const roomsFilter = numberR.value;
  const minFilter = minimumMeters.value;
  const maxFilter = maximumMeters.value;
  ...
  if (
    ...
    let clear = () => {
      ...
      document.getElementById("minimumMeters").value = "";
      document.getElementById("maximumMeters").value = "";
    };
    clear();
  }
  listDoom.innerHTML = "";
